...
// Generated by LSL2 Derived Files Generator. Database version: 0.0.20250202000; output module version: 0.0.20140615000
	...
	addFunction(10.f, 0.f, dummy_func, "llName2Key", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "llRequestUserKey", "k", "s");
	...
	addFunction(10.f, 0.f, dummy_func, "llGetObjectAnimationNames", "l", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetEnvironment", "l", "vl");
	addFunction(10.f, 0.f, dummy_func, "llGetDayLength", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetDayOffset", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetRegionDayLength", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetRegionDayOffset", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetMoonRotation", "q", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetRegionMoonRotation", "q", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetRegionSunRotation", "q", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetSunRotation", "q", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetMoonDirection", "v", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetRegionMoonDirection", "v", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetRegionSunDirection", "v", NULL);
	addFunction(10.f, 0.f, dummy_func, "llGetRegionTimeOfDay", "f", NULL);
	addFunction(10.f, 0.f, dummy_func, "llSetAgentEnvironment", "i", "kfl");
	addFunction(10.f, 0.f, dummy_func, "llReplaceAgentEnvironment", "i", "kfs");
	addFunction(10.f, 20.f, dummy_func, "llTargetedEmail", NULL, "iss");
	addFunction(10.f, 0.f, dummy_func, "llsRGB2Linear", "v", "v");
	addFunction(10.f, 0.f, dummy_func, "llLinear2sRGB", "v", "v");
	addFunction(10.f, 0.f, dummy_func, "llOrd", "i", "si");
	addFunction(10.f, 0.f, dummy_func, "llChar", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "llHash", "i", "s");
	addFunction(10.f, 0.f, dummy_func, "llOpenFloater", "i", "ssl", TRUE);
	addFunction(10.f, 0.f, dummy_func, "llGetInventoryAcquireTime", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "llGetVisualParams", "l", "kl");
	addFunction(10.f, 0.f, dummy_func, "llSetEnvironment", "i", "vl");
	addFunction(10.f, 0.f, dummy_func, "llReplaceEnvironment", "i", "vsiii");
	addFunction(10.f, 0.f, dummy_func, "llGetObjectLinkKey", "k", "ki");
	addFunction(10.f, 0.f, dummy_func, "llSHA256String", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataReset", NULL, NULL);
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataAvailable", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataCountKeys", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataWrite", "i", "ss");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataWriteProtected", "i", "sss");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataRead", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataReadProtected", "s", "ss");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataDelete", "i", "s");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataDeleteProtected", "i", "ss");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataFindKeys", "l", "sii");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataListKeys", "l", "ii");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataCountFound", "i", "s");
	addFunction(10.f, 0.f, dummy_func, "llLinksetDataDeleteFound", "l", "ss");
	addFunction(10.f, 0.f, dummy_func, "llGetRenderMaterial", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "llSetRenderMaterial", NULL, "si");
	addFunction(10.f, 0.f, dummy_func, "llSetLinkRenderMaterial", NULL, "isi");
	addFunction(10.f, 0.f, dummy_func, "llLinkPlaySound", NULL, "isfi");
	addFunction(10.f, 0.f, dummy_func, "llLinkStopSound", NULL, "i");
	addFunction(10.f, 0.1f, dummy_func, "llLinkAdjustSoundVolume", NULL, "if");
	addFunction(10.f, 0.f, dummy_func, "llLinkSetSoundQueueing", NULL, "ii");
	addFunction(10.f, 0.f, dummy_func, "llLinkSetSoundRadius", NULL, "if");
	addFunction(10.f, 0.f, dummy_func, "llHMAC", "s", "sss");
	addFunction(10.f, 0.f, dummy_func, "llSignRSA", "s", "sss");
	addFunction(10.f, 0.f, dummy_func, "llVerifyRSA", "i", "ssss");
	...
	addFunction(10.f, 0.f, dummy_func, "llGetInventoryDesc", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "llRezObjectWithParams", "k", "sl");
	addFunction(10.f, 0.f, dummy_func, "llSetLinkSitFlags", NULL, "ii");
	addFunction(10.f, 0.f, dummy_func, "llGetLinkSitFlags", "i", "i");
	...
	addFunction(10.f, 0.f, dummy_func, "llWorldPosToHUD", "v", "v");
	addFunction(10.f, 0.f, dummy_func, "llGetHealth", "f", "k");
	addFunction(10.f, 0.f, dummy_func, "llDerezObject", "i", "ki");
	addFunction(10.f, 0.f, dummy_func, "llGiveAgentInventory", "i", "ksll");
	addFunction(10.f, 0.f, dummy_func, "llTransferOwnership", "i", "kil");
	addFunction(10.f, 0.f, dummy_func, "llDetectedRezzer", "k", "i");
	addFunction(10.f, 0.f, dummy_func, "llDetectedDamage", "l", "i");
	addFunction(10.f, 0.f, dummy_func, "llFindNotecardTextCount", "k", "ssl");
	addFunction(10.f, 0.f, dummy_func, "llFindNotecardTextSync", "l", "ssiil");
	addFunction(10.f, 0.f, dummy_func, "llGetAttachedListFiltered", "l", "kl");
	...
	addFunction(10.f, 0.f, dummy_func, "llMapBeacon", NULL, "svl");
	addFunction(10.f, 0.f, dummy_func, "llSetAgentRot", NULL, "qi");
...
// Generated by LSL2 Derived Files Generator. Database version: 0.0.20250202000; output module version: 0.0.20140615000
	...
	addFunction(10.f, 0.f, dummy_func, "osSetDynamicTextureDataFace", "s", "ssssii");
	...
	addFunction(10.f, 0.f, dummy_func, "osRegionNotice", NULL, "ks");
	addFunction(10.f, 0.f, dummy_func, "osConsoleCommand", "i", "s");
	addFunction(10.f, 0.f, dummy_func, "osSetParcelMusicURL", NULL, "s");
	...
	addFunction(10.f, 0.f, dummy_func, "osLocalTeleportAgent", NULL, "kvvvi");
	addFunction(10.f, 0.f, dummy_func, "osTeleportAgent", NULL, "ssvv");
	addFunction(10.f, 0.f, dummy_func, "osTeleportAgent", NULL, "siivv");
	addFunction(10.f, 0.f, dummy_func, "osTeleportAgent", NULL, "svv");
	addFunction(10.f, 0.f, dummy_func, "osTeleportOwner", NULL, "svv");
	addFunction(10.f, 0.f, dummy_func, "osTeleportOwner", NULL, "iivv");
	addFunction(10.f, 0.f, dummy_func, "osTeleportOwner", NULL, "vv");
	...
	addFunction(10.f, 0.f, dummy_func, "osGetAvatarHomeURI", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "osGetNumberOfAttachments", "l", "kl");
	addFunction(10.f, 0.f, dummy_func, "osForceOtherSit", NULL, "ss");
	...
	addFunction(10.f, 0.f, dummy_func, "osDrawLine", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osDrawText", "s", "ss");
	addFunction(10.f, 0.f, dummy_func, "osDrawEllipse", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osDrawFilledEllipse", "s", "sii");
	...
	addFunction(10.f, 0.f, dummy_func, "osDrawResetTransform", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "osDrawRotationTransform", "s", "sf");
	addFunction(10.f, 0.f, dummy_func, "osDrawScaleTransform", "s", "sff");
	addFunction(10.f, 0.f, dummy_func, "osDrawTranslationTransform", "s", "sff");
	...
	addFunction(10.f, 0.f, dummy_func, "osGetParcelDwell", "i", "v");
	...
	addFunction(10.f, 0.f, dummy_func, "osGetPhysicsEngineName", "s", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetPhysicsEngineType", "s", NULL);
	...
	addFunction(10.f, 0.f, dummy_func, "osMakeNotecard", NULL, "ss");
	...
	addFunction(10.f, 0.f, dummy_func, "osSHA256", "s", "s");
	...
	addFunction(10.f, 0.f, dummy_func, "osNpcCreate", "k", "ssvsi");
	addFunction(10.f, 0.f, dummy_func, "osNpcSaveAppearance", "k", "ks");
	addFunction(10.f, 0.f, dummy_func, "osNpcSaveAppearance", "k", "ksi");
	...
	addFunction(10.f, 0.f, dummy_func, "osNpcSayTo", NULL, "kkis");
	...
	addFunction(10.f, 0.f, dummy_func, "osNpcSetProfileAbout", NULL, "ks");
	addFunction(10.f, 0.f, dummy_func, "osNpcSetProfileImage", NULL, "ks");
	addFunction(10.f, 0.f, dummy_func, "osOwnerSaveAppearance", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "osOwnerSaveAppearance", "k", "si");
	addFunction(10.f, 0.f, dummy_func, "osAgentSaveAppearance", "k", "ks");
	addFunction(10.f, 0.f, dummy_func, "osAgentSaveAppearance", "k", "ksi");
	addFunction(10.f, 0.f, dummy_func, "osGetMapTexture", "k", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetRegionMapTexture", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "osGetRegionSize", "v", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetRegionStats", "l", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetSimulatorMemory", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetSimulatorMemoryKB", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "osKickAvatar", NULL, "sss");
	addFunction(10.f, 0.f, dummy_func, "osKickAvatar", NULL, "ks");
	addFunction(10.f, 0.f, dummy_func, "osSetSpeed", NULL, "kf");
	addFunction(10.f, 0.f, dummy_func, "osSetOwnerSpeed", NULL, "f");
	addFunction(10.f, 0.f, dummy_func, "osGetHealth", "f", "k");
	addFunction(10.f, 0.f, dummy_func, "osSetHealth", NULL, "kf");
	addFunction(10.f, 0.f, dummy_func, "osGetHealRate", "f", "k");
	addFunction(10.f, 0.f, dummy_func, "osSetHealRate", NULL, "kf");
	addFunction(10.f, 0.f, dummy_func, "osCauseHealing", NULL, "kf");
	addFunction(10.f, 0.f, dummy_func, "osCauseDamage", NULL, "kf");
	addFunction(10.f, 0.f, dummy_func, "osDie", NULL, "k");
	...
	addFunction(10.f, 0.f, dummy_func, "osSetProjectionParams", NULL, "iikfff");
	addFunction(10.f, 0.f, dummy_func, "osGetAvatarList", "l", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetNPCList", "l", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetGender", "s", "k");
	addFunction(10.f, 0.f, dummy_func, "osUnixTimeToTimestamp", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "osForceBreakAllLinks", NULL, NULL);
	addFunction(10.f, 0.f, dummy_func, "osForceBreakLink", NULL, "i");
	addFunction(10.f, 0.f, dummy_func, "osForceCreateLink", NULL, "si");
	...
	addFunction(10.f, 0.f, dummy_func, "osRequestURL", "k", "l");
	addFunction(10.f, 0.f, dummy_func, "osRequestSecureURL", "k", "l");
	addFunction(10.f, 0.f, dummy_func, "osCheckODE", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "osCollisionSound", NULL, "sf");
	addFunction(10.f, 0.f, dummy_func, "osVolumeDetect", NULL, "i");
	addFunction(10.f, 0.f, dummy_func, "osGetInertiaData", "l", NULL);
	addFunction(10.f, 0.f, dummy_func, "osClearInertia", NULL, NULL);
	addFunction(10.f, 0.f, dummy_func, "osSetInertia", NULL, "fvvq");
	addFunction(10.f, 0.f, dummy_func, "osSetInertiaAsBox", NULL, "fvvq");
	addFunction(10.f, 0.f, dummy_func, "osSetInertiaAsSphere", NULL, "ffv");
	addFunction(10.f, 0.f, dummy_func, "osSetInertiaAsCylinder", NULL, "fffvq");
	addFunction(10.f, 0.f, dummy_func, "osTeleportObject", "i", "kvqi");
	addFunction(10.f, 0.f, dummy_func, "osGetLinkNumber", "i", "s");
	addFunction(10.f, 0.f, dummy_func, "osRound", "f", "fi");
	addFunction(10.f, 0.f, dummy_func, "osVecMagSquare", "f", "v");
	addFunction(10.f, 0.f, dummy_func, "osVecDistSquare", "f", "vv");
	addFunction(10.f, 0.f, dummy_func, "osAngleBetween", "f", "vv");
	addFunction(10.f, 0.f, dummy_func, "osAdjustSoundVolume", NULL, "if");
	addFunction(10.f, 0.f, dummy_func, "osLoopSound", NULL, "isf");
	addFunction(10.f, 0.f, dummy_func, "osLoopSoundMaster", NULL, "isf");
	addFunction(10.f, 0.f, dummy_func, "osLoopSoundSlave", NULL, "isf");
	addFunction(10.f, 0.f, dummy_func, "osPlaySound", NULL, "isf");
	addFunction(10.f, 0.f, dummy_func, "osPlaySoundSlave", NULL, "isf");
	addFunction(10.f, 0.f, dummy_func, "osPreloadSound", NULL, "is");
	addFunction(10.f, 0.f, dummy_func, "osSetSoundRadius", NULL, "if");
	addFunction(10.f, 0.f, dummy_func, "osStopSound", NULL, "i");
	addFunction(10.f, 0.f, dummy_func, "osTriggerSound", NULL, "isf");
	addFunction(10.f, 0.f, dummy_func, "osTriggerSoundLimited", NULL, "isfvv");
	addFunction(10.f, 0.f, dummy_func, "osDetectedCountry", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "osGetAgentCountry", "s", "k");
	addFunction(10.f, 0.f, dummy_func, "osStringSubString", "s", "si");
	addFunction(10.f, 0.f, dummy_func, "osStringSubString", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osStringStartsWith", "i", "ssi");
	addFunction(10.f, 0.f, dummy_func, "osStringEndsWith", "i", "ssi");
	addFunction(10.f, 0.f, dummy_func, "osStringIndexOf", "i", "ssi");
	addFunction(10.f, 0.f, dummy_func, "osStringIndexOf", "i", "ssiii");
	addFunction(10.f, 0.f, dummy_func, "osStringLastIndexOf", "i", "ssi");
	addFunction(10.f, 0.f, dummy_func, "osStringLastIndexOf", "i", "ssiii");
	addFunction(10.f, 0.f, dummy_func, "osStringRemove", "s", "sii");
	addFunction(10.f, 0.f, dummy_func, "osStringReplace", "s", "sss");
	addFunction(10.f, 0.f, dummy_func, "osApproxEquals", "i", "ff");
	addFunction(10.f, 0.f, dummy_func, "osApproxEquals", "i", "fff");
	addFunction(10.f, 0.f, dummy_func, "osApproxEquals", "i", "vv");
	addFunction(10.f, 0.f, dummy_func, "osApproxEquals", "i", "vvf");
	addFunction(10.f, 0.f, dummy_func, "osApproxEquals", "i", "qq");
	addFunction(10.f, 0.f, dummy_func, "osApproxEquals", "i", "qqf");
	addFunction(10.f, 0.f, dummy_func, "osGetInventoryLastOwner", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "osGetInventoryItemKey", "k", "s");
	addFunction(10.f, 0.f, dummy_func, "osGetInventoryName", "s", "k");
	addFunction(10.f, 0.f, dummy_func, "osGetInventoryDesc", "s", "s");
	addFunction(10.f, 0.f, dummy_func, "osGetLastChangedEventKey", "k", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetPSTWallclock", "f", NULL);
	addFunction(10.f, 0.f, dummy_func, "osSlerp", "q", "qqf");
	addFunction(10.f, 0.f, dummy_func, "osSlerp", "v", "vvf");
	addFunction(10.f, 0.f, dummy_func, "osResetAllScripts", NULL, "i");
	addFunction(10.f, 0.f, dummy_func, "osIsNotValidNumber", "i", "f");
	addFunction(10.f, 0.f, dummy_func, "osSetSitActiveRange", NULL, "f");
	addFunction(10.f, 0.f, dummy_func, "osSetLinkSitActiveRange", NULL, "if");
	addFunction(10.f, 0.f, dummy_func, "osGetSitActiveRange", "f", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetLinkSitActiveRange", "f", "i");
	addFunction(10.f, 0.f, dummy_func, "osSetStandTarget", NULL, "v");
	addFunction(10.f, 0.f, dummy_func, "osSetLinkStandTarget", NULL, "iv");
	addFunction(10.f, 0.f, dummy_func, "osGetStandTarget", "v", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetLinkStandTarget", "v", "i");
	addFunction(10.f, 0.f, dummy_func, "osClearObjectAnimations", "i", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetApparentTime", "f", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetApparentTimeString", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "osGetApparentRegionTime", "f", NULL);
	addFunction(10.f, 0.f, dummy_func, "osGetApparentRegionTimeString", "s", "i");
	addFunction(10.f, 0.f, dummy_func, "osReplaceAgentEnvironment", "i", "kis");
	addFunction(10.f, 0.f, dummy_func, "osReplaceParcelEnvironment", "i", "is");
	addFunction(10.f, 0.f, dummy_func, "osReplaceRegionEnvironment", "i", "isfffff");
	addFunction(10.f, 0.f, dummy_func, "osResetEnvironment", "i", "ii");
	addFunction(10.f, 0.f, dummy_func, "osParticleSystem", NULL, "l");
	addFunction(10.f, 0.f, dummy_func, "osLinkParticleSystem", NULL, "il");
	addFunction(10.f, 0.f, dummy_func, "osNpcLookAt", "i", "kikv");
	addFunction(10.f, 0.f, dummy_func, "osAvatarType", "i", "k");
	addFunction(10.f, 0.f, dummy_func, "osAvatarType", "i", "ss");
	addFunction(10.f, 0.f, dummy_func, "osListSortInPlace", NULL, "lii");
